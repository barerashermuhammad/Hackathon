...
import vector from "./../image/vector 12.png"
import search from "./../image/search 6.png";
import cart from "./../image/cart 7.png";
import like from "./../image/like 8.png";
        ...
        <div className="w-[324px] h-[54px] absolute top-[2px] left-[832px] flex justify-between items-center">
          <div className="w-[166px] h-[54px] p-[15px] flex items-center gap-[5px]">
            <div className="w-[12px] h-[12px] mt-[6px]">
              <Image src={vector} alt="vector 12" width={12} height={12} />
            </div>
          ...
          <ul className="flex gap-[15px] items-center">
            <li>
              <Image src={search} alt="search 6" width={16} height={16} />
            </li>
            <li>
              <Image src={cart} alt="cart 7" width={16} height={16} />
            </li>
            <li>
              <Image src={like} alt="like 8" width={16} height={16} />
            </li>
          </ul>
        </div>
      </div>
